			...
			<ul class="profile-info-sections">
				<li style="padding:0px; margin:0px;">
					<div class="profile-name">
							<h3>
                                <?php echo $this->db->get_where('student' , array('student_id' => $param2))->row()->student_title;?> <?php echo $this->db->get_where('student' , array('student_id' => $param2))->row()->name;?>                     
                            </h3>
					</div>
				</li>
			</ul>
			...
			<div class="">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                     ...
                     <tr>
                        <td><?php echo get_phrase('admission_category');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->admission_cat;?></b>
                        </td>
                    </tr>
					<tr>
                        <td><?php echo get_phrase('nationality');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->nationality;?></b>
                        </td>
                    </tr>
					<tr>
                        <td><?php echo get_phrase('student_status');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->student_status;?></b>
                        </td>
                    </tr>
					<tr>
                        <td><?php echo get_phrase('admission_date');?></td>
                        <td><b><?php echo $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->admission_date;?></b>
                        </td>
                    </tr>
                </table>
			</div>
