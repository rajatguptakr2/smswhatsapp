<hr />
 ...
 <?php if($this->session->flashdata('not_sent')){ ?>
      <div class='alert alert-danger row' style="text-align: center;">
      Message not sent to :
      <?php 
        foreach ($this->session->flashdata('not_sent') as $not_sent) 
          {
            echo '<br>'.$not_sent;
          }
  ...
  <?php if($this->session->flashdata('sent')){ ?>
      ...
      <?php 
        ...
        foreach ($this->session->flashdata('sent') as $sent) 
          {
            echo '<br>'.$sent;
          }
      ?>
 ...
 <?php 
    ...
    if($this->session->flashdata('not_sent_group')){ ?>
      <div class='alert alert-danger row' style="text-align: center;">
      Message not sent to :
      <?php 
        foreach($this->session->flashdata('not_sent_group') as $not_sent_group) 
          {
            echo '<br>'.$not_sent_group;
          }
        
      ?>
    </div>
  <?php }?>
  <?php if($this->session->flashdata('sent_group')){ ?>
      <div class='alert alert-success row ' style="text-align: center;">
      Message sent to :
      <?php 
        
        foreach ($this->session->flashdata('sent_group') as $sent_group) 
          {
            echo '<br>'.$sent_group;
          }
      ?>
